...
app.post("/submit", (req, res) => {
  ...
  const randomAdjIdx = Math.floor(Math.random() * adj.length);
  const randomNounIdx = Math.floor(Math.random() * noun.length);

  // res.locals.getAdj = adj[randomAdjIdx];
  // res.locals.getNoun = noun[randomNounIdx];

  // res.render("index.ejs");
  res.render("index.ejs", {
    getAdj: adj[randomAdjIdx],
    getNoun: noun[randomNounIdx],
  });
  console.logadj[randomAdjIdx];
